...
if(isset($_POST['loginbtn'])){
	...
	$stmtLogin=$conn->prepare("SELECT * FROM tbl_adminllogin WHERE adm_email=:adm_email AND adm_password=:adm_password");
...
<head>
	...
	<title>Park Mate-Admin Login</title>
					...
					<form method="POST">
						<div class="panel panel-body login-form">
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="email" name="adm_email" required class="form-control" placeholder="Email">
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="password" name="adm_password" required class="form-control" placeholder="Password">
								<div class="form-control-feedback">
